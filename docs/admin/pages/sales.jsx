...
const Sales = () => {
  ...
  return (
    ...
    <div className="p-4 sm:p-6 bg-gray-100 min-h-screen">
      <h1 className="text-2xl sm:text-3xl font-bold text-red-700 mb-4">Real-Time Sales Tracker</h1>

      {/* Add Sale Form */}
      <div className="flex flex-col sm:flex-row flex-wrap gap-4 mb-6">
        <select
          className="w-full sm:w-auto flex-grow px-4 py-2 border rounded"
          value={selectedItem}
      ...
      <div className="flex flex-col sm:flex-row flex-wrap gap-3 mb-6 ">
        ...
        <button
          ...
          className="w-full sm:w-auto bg-gray-500 text-white px-3 py-2 rounded"
        >
          Reset Filter
        </button>
        <button onClick={exportToCSV} className="w-full sm:w-auto bg-green-600 text-white px-3 py-2 rounded hover:bg-green-700 transition">
          Export CSV
        </button>
        <button onClick={exportToPDF} className="w-full sm:w-auto bg-blue-600 text-white px-3 py-2 rounded hover:bg-blue-700 transition">
          Export PDF
        </button>
      </div>
